<?php
	...
	if (isset($_POST['addButton'])) {
		...
		$mysqli->query("UPDATE emp SET surname = '$surname', patr = '$patr', dateOfBirth = '$dateOfBirth', profName = '$profName', educ = '$educ', workPlace = '$workPlace', workPos = '$workPos', `leaveReason` = '$leaveReason', famPos = '$famPos', home = '$home', contact = '$contact', req = '$req' WHERE emp.id = $id;");
	}
		...
		<div class="tabs">
			<div>
				<form action="" method="post">
					<label>
						№ <br>
						<input type="text" name="id" pattern="[0-9]{1,}">
					</label>
					<br>
					<label>
						Фамилия <br>
					...
					<br>
					<label>
						Должность на последней работы <br>
